...
(function () {
  ...
  const DICT = {
    "pt-BR": {
      ...
      "resume.r.linked.a.res2": "Reduzi ~5% da fatura de nuvem ao corrigir um bug de consumo excessivo de portas que disparava escalonamento indevido (falso positivo).",
      "resume.r.linked.a.res3": "Reduzi ~15% do custo de hospedagem migrando serviços .NET Core de Windows para Linux, após adequar bibliotecas sem suporte ao Linux.",
    ...
    "en": {
      ...
      "resume.r.linked.a.res2": "Reduced cloud costs by ~5% by fixing an excessive port-consumption bug that triggered unnecessary auto-scaling (false positive).",
      "resume.r.linked.a.res3": "Reduced hosting costs by ~15% by migrating .NET Core services from Windows to Linux, after adapting libraries that lacked Linux support.",
