...
(function () {
  ...
  const DICT = {
    "pt-BR": {
      ...
      "resume.r.linked.a.res2": "Reduzi cerca de 30% do custo de nuvem ao corrigir bugs de consumo excessivo (ex.: escalonamento indevido por esgotamento de portas), migrar a hospedagem de Windows para Linux e otimizar soluções existentes.",
    ...
    "en": {
      ...
      "resume.r.linked.a.res2": "Reduced cloud costs by around 30% by fixing excessive-consumption bugs (e.g., unnecessary auto-scaling caused by port exhaustion), migrating hosting from Windows to Linux and optimizing existing solutions.",
